...
export default function Navigation({ show }) {
    ...
    const activeLink = inactiveLink + ' bg-white text-black poppins-medium rounded-l-lg'
    ...
    return (
        <aside className={(show ? 'left-0 z-50' : '-left-full') + " top-0 text-black poppins-regular pl-4 fixed w-full bg-[white] h-full md:static md:w-auto transition-all backdrop-blur-lg "}>
            <a className="flex gap-1 mb-4 mr-4 mt-[1.7rem]">
                ...
                <span className="">EcommereceAdmin</span>
            </a>
