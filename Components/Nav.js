...
export default function Navigation({ show }) {
    ...
    return (
        <aside className={(show ? 'left-0 z-50' : '-left-full') + " top-0 text-white poppins-regular pl-4 fixed w-full bg-[#262626] h-full md:static md:w-auto transition-all backdrop-blur-lg"}>
