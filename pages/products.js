...
export default function Products() {
  ...
  return (
    <Layout>
      <main className="w-[82vw] flex flex-col items-center justify-center max-h-[auto] min-h-[43rem] max600:w-[95vw] max600:relative max600:mt-6">
        <section className="w-full h-[7%] rounded-t-[0.8rem] flex items-center justify-between mt-2 px-4">
          ...
          <Link className="bg-[#ffffff] border border-black rounded-[4px] text-[black] py-2 px-4 flex items-center mr-8 max600:absolute max600:top-[-1.4%] max600:right-[-5%] max600:p-1 max600:rounded-[7px]" href={'/products/new'}>+ Add product</Link>
        </section>
        <section className="table_body K2D w-[95%] rounded-[6px] overflow-auto bg-[#fffb] my-[0.8rem] mx-auto custom-scrollbar">
