  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <form onSubmit={saveCategory}>
          ...
          <div className="mb-2 mr-2 flex justify-end w-[80vw] ">
            <button
              onClick={addProperty}
              type="button"
              className="py-1 px-3 mr-2 rounded-[4px] border border-black bg-[#ffffff] text-black text-[1rem] font-[400] mb-2">
              Add new property
            </button>
        ...
        {!editedCategory && (
          <main className="w-[82vw] max-h-[auto] min-h-[43rem] max600:w-[90vw] max600:relative">
            <section className="w-full h-[7%] rounded-t-[0.8rem] flex items-center justify-between">
            <div className="flex border border-black bg-white h-[2.4rem] mr-[4rem] w-[28.25rem] rounded-[0.1875rem] p-[0.1rem] max600:mr-[1.2rem] max600:my-[0.3rem] max600:w-[80vw]">
              ...
              <button className="bg-[#ffffff] border border-black text-black rounded-[4px] py-1 px-4 flex items-center mr-8 max600:absolute max600:top-[-5%] max600:right-[-5%] max600:p-1 max600:rounded-[7px]" onClick={addCategory}>+ Add Category</button>
            </section>
            <section className="table_body K2D w-[95%] overflow-auto my-[0.8rem] mx-auto custom-scrollbar">
              <table className="w-[100%]">
                <thead className="border-b-2 text-[1.1rem] font-[600] border-[#949494]">
                  <tr>
                    <td>Category name</td>
